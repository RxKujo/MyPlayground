...
<div class="d-flex">
    <nav class="bg-light text-black p-3" style="width: 280px; min-height: 100vh;">
        <ul id="sidebar-list" class="nav nav-pills flex-column">
            ...
            <li class="nav-item"><a class="nav-link active fs-5 fw-bold text-black" href="#" data-page="settings">⚙️ Settings</a></li>
        </ul>
    </nav>
    
    
    <div class="container-fluid px-0" id="content">
        <form method='post' action= <?= $root . '/deauth.php' ?> id='settings-form'>
