...
<nav class="bg-dark text-white p-3" style="width: 280px; min-height: 100vh;">
    ...
    <ul id="sidebar-list" class="nav nav-pills flex-column">
        ...
        <li class="nav-item"><a class="nav-link text-white" href="logs" data-page="logs"><?=  $fileRuledFill ?> Logs</a>        <li class="nav-item"><a class="nav-link text-white" href="settings" data-page="settings"><?= $gearFill ?> Settings</a></li>
